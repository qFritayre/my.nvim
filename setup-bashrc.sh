...
install_additional_dependencies() {
   sudo apt update
   ## jpico is part of joe
   sudo apt install -y trash-cli bat meld joe net-tools 
}
...
linkConfig() {
    ...
    ## Make symbolic link.
    ln -svf ${GITPATH}/setup-bashrc/.bashrc ${USER_HOME}/.bashrc
    ln -svf ${GITPATH}/setup-bashrc/starship.toml ${USER_HOME}/.config/starship.toml
}
